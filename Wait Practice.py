...
add_cart = driver.find_elements(By.XPATH, "//div[@class='products']/div")#storing all the searched produsts which are displayed in a variable
print(len(add_cart))
for clickadd in add_cart:#Using for loop in the searched product list to click on all the add to cart button
